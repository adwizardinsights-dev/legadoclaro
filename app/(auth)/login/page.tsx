      ...
      <div className="bg-white rounded-2xl shadow-sm border border-border p-8">
        <div className="mb-8">
          ...
          <p className="text-brand-slate text-sm">
            Inicia sesión para continuar con tu planificación patrimonial.
          </p>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs text-brand-slate">
            <span className="bg-white px-3">o inicia sesión con correo</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <Link
                href="/reset-password"
                className="text-xs text-brand-slate hover:text-brand-navy hover:underline"
              >
